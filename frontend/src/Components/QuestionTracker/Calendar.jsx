            ...
            <Tooltip>
                <TooltipTrigger asChild>
                    <div
                        ...
                        style={{
                            borderLeftColor: getPlatformColor(event.platform),
                            borderLeftWidth: '4px'
                        }}
                    >
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-7 gap-0.5 bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
                    ...
                    {emptyCells.map((_, index) => (
                        <div
                            key={`empty-${index}`}
                            className="date-cell bg-white min-h-[100px] border border-gray-100"
                        ></div>
                    ))}
                    ...
                    {days.map(day => {
                        ...
                        return (
                            <div
                                key={day.toString()}
                                className={`date-cell min-h-[100px] p-2 bg-white border border-gray-100 hover:bg-gray-50 transition-colors ${isToday ? 'border-2 border-blue-500' : ''
                                    }`}
                            >
